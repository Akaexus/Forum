...
INSERT INTO `members` VALUES (1,'Damazy Pióropusz','admin@admin.pl','2020-11-02 20:27:00','$2y$10$8cDiLIHLQbx..Wbbh/oiOuEimKeoe3jHx1gSrbLrK769ajSw0RZim',1,'Kapucyn[1] (zwany przez miejscową ludność Ostrym Kamieniem[2]) – ostaniec wierzchowinowy wchodzący w skład grupy skał zwanych Ostańcami Jerzmanowickimi. Znajduje się w najwyższych partiach Wyżyny Olkuskiej, w miejscowości Jerzmanowice, w odległości ok. 800 m na południowy zachód od drogi krajowej nr 94[3]. Jest jednym z ostańców w grupie skał ciągnących się od Grodziska, zwanego też Wzgórzem 502 lub Skałą 502, w północnym kierunku. W grupie tej kolejno znajdują się: Grodzisko, Mały Mur, Kapucyn, Słup (Palec), Soczewka, Ostry Kamień i Polna Skałka[1]. '),(2,'user1','admin2@admin.pl','2021-11-02 21:44:00','$2y$10$/3WDPhvZXEs2pQlxijiXouPcoN9xy9p3QMvvs.2sjh1awM8M1Vi/K',0,'<strong>poland strong</strong> tak'),(3,'admin3','admin3@admin.pl','2021-11-02 21:45:44','$2y$10$/Hrmgo4GomLR5MIAh0JTce3rLPRcpcrNg5aeNyVB3hi/csYr1auk.',0,NULL),(4,'admin4','admin4@admin.pl','2021-11-02 21:47:19','$2y$10$RQJjvSv4NNIcMFSqH/.6buLjsS1pCx9bsWMyJOSuEFSlAa.7oCzTa',0,NULL);
...
INSERT INTO `reactions` VALUES (10,1,3),(11,1,2);
...
INSERT INTO `topics` VALUES (1,'Bardzo długa nazwa tematu, która jest za długa','2021-11-06 15:26:29',1,1),(4,'siema siema elo 2137','2021-11-07 22:18:23',1,1);
...
-- Dump completed on 2021-11-13 23:27:58
